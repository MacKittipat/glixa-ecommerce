...
<div class="datatable">
    ...
    <table id="datatable_table" border="1">
        ...
        ?>
            <tr>
                ...
                <td>
                    <?php
                        echo anchor('admin/purchase/edit/'.$row['id'],$row['supplier_name'].' '.$row['create_date']);
                    ?>
                </td>
                <td>
                <?php
    ...
    <div>
        <input type="button" style="display: none;" name="btn_del" id="btn_del" value="Delete" onclick="datatable_delete('delete');" />
    </div>
