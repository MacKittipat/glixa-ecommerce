...
//		$str .= '<form method="post" action="'.$this->paypal_url.'" name="'.$form_name.'"/>' . "\n";
	function paypal_form($form_name='paypal_form')
        {
            $str = '';
            $str .= '<form id="frm_payment_paypal" method="post" action="'.$this->_get_paypal_url().'" name="'.$form_name.'">' . "\n";
...
//		$url_parsed = parse_url($this->paypal_url);
                $url_parsed = parse_url($this->_get_paypal_url());
...
//		}
	...
	function dump() 
	{
        ...
        function sand_box($value)
        {
            $this->is_sand_box=$value;
        }
}
